...
@section('title', 'Editar Propuesta de Candidato')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-edit"></i> Editar Propuesta como Candidato
        </h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('votante.propuestas_candidato.actualizar', $propuesta->idPropuesta) }}" method="POST">
                @csrf
                @method('PUT')
