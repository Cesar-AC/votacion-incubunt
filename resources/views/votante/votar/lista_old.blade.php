...
<div class="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8" x-data="votingForm()">
    <div class="max-w-7xl mx-auto">
        ...
        <form id="votingForm" action="#" method="POST" data-eleccion-id="{{ $eleccionActiva->getKey() }}">
            @csrf
            ...
            <div class="mb-12">
                ...
                @forelse($candidatosPorArea as $candidatoEleccion)
                ...
                <div class="mb-8">
                    <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center">
                        ...
                        {{ $candidatoEleccion->cargo->cargo }}
                    </h3>

                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        @forelse($candidatoEleccion->candidatos as $candidato)
                        <div class="bg-white rounded-xl shadow-md p-4 cursor-pointer transition-all duration-300 hover:shadow-xl border-2"
                            :class="selectedCandidates[{{ $candidatoEleccion->cargo->idCargo }}] === {{ $candidato->idCandidato }} ? 'border-purple-600 bg-purple-50' : 'border-gray-200'"
