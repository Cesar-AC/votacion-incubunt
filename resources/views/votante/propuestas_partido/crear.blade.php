...
@section('title', 'Crear Propuesta de Partido')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-plus-circle"></i> Nueva Propuesta de Partido
        </h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <p class="mb-0 text-muted">Estás creando una propuesta para este partido político.</p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('votante.propuestas_partido.guardar') }}" method="POST">
                @csrf
