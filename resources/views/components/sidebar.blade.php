@php
    ...
    // Helper para estilos activos (sin <style> inline, usando lógica limpia)
    if (!function_exists('getNavLinkStyles')) {
        function getNavLinkStyles($route) {
            $isActive = request()->routeIs($route);
            // Si es activo: Amarillo (#ffb700) y negrita. 
            // Si no: Hereda el color definido en CSS (blanco/gris).
            return $isActive 
                ? 'color: #ffb700; font-weight: 700;' 
                : ''; 
        }
    }
@endphp
